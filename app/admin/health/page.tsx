      ...
      <div className="flex flex-col gap-8 mb-16 relative z-10">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <span className="text-[10px] font-black uppercase tracking-[0.4em] text-oku-darkgrey/30">System Monitoring</span>
          </div>
          <h1 className="heading-display text-5xl lg:text-7xl text-oku-darkgrey tracking-tighter">
            System <span className="text-oku-purple-dark italic">Health.</span>
          </h1>
