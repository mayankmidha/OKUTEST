...
export default function OriginalV1Homepage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Navigation - using same structure as V1 login */}
      ...
      {/* Hero Section - matching original V1 */}
      <div className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="relative inline-block">
            <h2 className="text-4xl font-bold text-gray-900" style={{ fontFamily: 'Nothing You Could Do, cursive' }}>
              grief
            </h2>
          </div>
