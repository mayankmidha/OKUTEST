...
const posts = [
  // ─── ADHD ─────────────────────────────────────────────────────────────────
  {
    ...
    title: 'Getting Diagnosed with ADHD as an Adult: What No One Tells You',
    category: 'ADHD',
    excerpt: 'Receiving an ADHD diagnosis as an adult can feel like relief, grief, and confusion all at once. Here is what to expect — and how to move forward.',
    content: `# Getting Diagnosed with ADHD as an Adult: What No One Tells You
...
The diagnosis is just the beginning. The work that follows is worth every moment.`,
  ...
  {
    slug: 'adhd-hyperfocus-superpower-or-symptom',
    title: 'Hyperfocus: The ADHD Superpower That Can Also Trap You',
    category: 'ADHD',
    excerpt: 'Hyperfocus lets you vanish into a task for hours. It is also one of the most misunderstood aspects of ADHD — neither a superpower nor a burden, but something in between.',
    content: `# Hyperfocus: The ADHD Superpower That Can Also Trap You
...
If you are navigating ADHD and would like support developing personalised strategies, OKU Therapy connects you with therapists who specialise in neurodivergent care.`,
  ...
  {
    slug: 'adhd-executive-function-what-it-means',
    title: 'Executive Function and ADHD: Why "Just Do It" Is Not Helpful Advice',
    category: 'ADHD',
    excerpt: 'Executive function deficits are the core of ADHD. Understanding what they are — and are not — changes how you support yourself and others.',
    content: `# Executive Function and ADHD: Why "Just Do It" Is Not Helpful Advice
...
You do not need to "just do it." You need the right environment, the right strategies, and a therapist who understands your brain.`,
  },
  {
    ...
    title: 'Rejection Sensitive Dysphoria: The Emotional Side of ADHD Nobody Warns You About',
    category: 'ADHD',
    excerpt: 'RSD is not oversensitivity. It is a neurological feature of ADHD that causes extreme emotional pain in response to perceived rejection — and it shapes entire life trajectories.',
    content: `# Rejection Sensitive Dysphoria: The Emotional Side of ADHD Nobody Warns You About
...
You deserve a therapist who knows what RSD is. OKU Therapy can help you find one.`,
  ...
  {
    slug: 'adhd-in-women-the-invisible-epidemic',
    title: 'ADHD in Women: Why So Many Are Diagnosed Decades Too Late',
    category: 'ADHD',
    excerpt: 'ADHD in women and girls presents differently, gets dismissed more readily, and carries a heavier toll of shame and misdiagnosis. Here is why — and what needs to change.',
    content: `# ADHD in Women: Why So Many Are Diagnosed Decades Too Late
...
OKU Therapy works with therapists who specialise in adult and female presentations of ADHD. You do not have to figure this out alone.`,
  ...
  {
    slug: 'adhd-medication-myths-facts',
    title: 'ADHD Medication: Separating Myths from Evidence',
    category: 'ADHD',
    excerpt: 'ADHD medication is among the most studied psychiatric treatments in existence — and among the most misunderstood. Here is what the evidence actually says.',
    content: `# ADHD Medication: Separating Myths from Evidence
...
If you are considering ADHD assessment or treatment in India, OKU Therapy can connect you with qualified practitioners who can guide you through your options.`,
  ...
  // ─── ANXIETY ──────────────────────────────────────────────────────────────
  {
    slug: 'understanding-panic-attacks',
    title: 'Panic Attacks: What They Are, Why They Happen, and How to Navigate Them',
    category: 'Anxiety',
    excerpt: 'Panic attacks feel like dying. They are not — but that experience deserves a real explanation, not dismissal. Here is what is actually happening in your body and brain.',
    content: `# Panic Attacks: What They Are, Why They Happen, and How to Navigate Them
...
OKU Therapy connects you with therapists trained in anxiety disorders. You do not have to keep white-knuckling this alone.`,
  ...
  {
    slug: 'social-anxiety-beyond-shyness',
    title: 'Social Anxiety: When the Fear of People Takes Over Your Life',
    category: 'Anxiety',
    excerpt: 'Social anxiety is not shyness. It is a pervasive fear of negative evaluation that can limit every domain of life — and it is one of the most treatable conditions in mental health.',
    content: `# Social Anxiety: When the Fear of People Takes Over Your Life
...
OKU Therapy offers access to therapists trained in anxiety disorders across India. You deserve to live a life that is not defined by fear of other people.`,
  ...
  {
    slug: 'health-anxiety-when-worry-becomes-illness',
    title: 'Health Anxiety: When the Fear of Illness Becomes the Problem',
    category: 'Anxiety',
    excerpt: 'Health anxiety drives people to seek reassurance that temporarily relieves but ultimately worsens their fear. Understanding the cycle is the first step to breaking it.',
    content: `# Health Anxiety: When the Fear of Illness Becomes the Problem
...
If you recognise yourself in this article, reaching out to a therapist who understands health anxiety is a meaningful next step. The cycle can be broken.`,
  ...
  {
    slug: 'generalized-anxiety-the-worry-that-never-stops',
    title: 'Generalised Anxiety Disorder: When Your Brain Will Not Stop Worrying',
    category: 'Anxiety',
    excerpt: 'GAD is not about being a worrier. It is a condition where worry is uncontrollable, exhausting, and pervasive — about everything, all the time.',
    content: `# Generalised Anxiety Disorder: When Your Brain Will Not Stop Worrying
...
GAD is very treatable. With the right support, the worry that has organised your life can loosen its grip.`,
  ...
  {
    slug: 'intrusive-thoughts-and-ocd',
    title: 'Intrusive Thoughts and OCD: What Your Brain Fears Does Not Define You',
    category: 'Anxiety',
    excerpt: 'Intrusive thoughts are universal. OCD is when the response to those thoughts — the desperate effort to neutralise them — takes over your life.',
    content: `# Intrusive Thoughts and OCD: What Your Brain Fears Does Not Define You
...
If OCD is making your life smaller, effective help exists. A therapist trained in ERP can guide you through this process.`,
  ...
  // ─── DEPRESSION ───────────────────────────────────────────────────────────
  {
    ...
    title: 'High-Functioning Depression: When You Look Fine but Feel Like You Are Drowning',
    category: 'Depression',
    excerpt: 'High-functioning depression is real, it is exhausting, and it often goes unrecognised precisely because the person experiencing it continues to perform.',
    content: `# High-Functioning Depression: When You Look Fine but Feel Like You Are Drowning
...
A therapist can help you understand what you are experiencing, develop language for it, and work toward genuine recovery — not just continued performance. Effective treatment for depression exists. You do not have to keep maintaining the façade alone.`,
  ...
  {
    slug: 'grief-vs-depression-understanding-the-difference',
    title: 'Grief and Depression: Understanding the Difference — and the Overlap',
    category: 'Depression',
    excerpt: 'Grief is a healthy response to loss. Depression is an illness. Both can coexist, and confusing them has real consequences for treatment.',
    content: `# Grief and Depression: Understanding the Difference — and the Overlap
...
Seeking help does not mean you are grieving "wrong." It means you are taking your pain seriously enough to give it the support it deserves.`,
  ...
  {
    slug: 'postpartum-depression-what-new-mothers-deserve-to-know',
    title: 'Postpartum Depression: What New Mothers Deserve to Know',
    category: 'Depression',
    excerpt: 'Postpartum depression affects one in five new mothers. It is not a failure of love. It is a medical condition that requires and responds to treatment.',
    content: `# Postpartum Depression: What New Mothers Deserve to Know
...
If you or someone you know may be experiencing PPD, please reach out. This is not a character failing. It is an illness with effective treatments. You deserve support, not silence.`,
  ...
  {
    slug: 'seasonal-depression-understanding-sad',
    title: 'Seasonal Affective Disorder: When the Seasons Change Your Brain',
    category: 'Depression',
    excerpt: 'SAD is a pattern of depression that tracks the seasons — and it is more common, and more treatable, than most people realise.',
    content: `# Seasonal Affective Disorder: When the Seasons Change Your Brain
...
If you notice a predictable seasonal dip, you are not imagining it. And you do not have to simply endure it.`,
  ...
  {
    slug: 'depression-recovery-what-it-actually-looks-like',
    title: 'What Depression Recovery Actually Looks Like',
    category: 'Depression',
    excerpt: 'Recovery from depression is not a straight line. It is not one moment of breakthrough. It is a series of small shifts that eventually change everything.',
    content: `# What Depression Recovery Actually Looks Like
...
A therapist and possibly a psychiatrist can provide the external structure that depression makes internally impossible. Recovery does not happen in isolation.`,
  ...
  // ─── TRAUMA ───────────────────────────────────────────────────────────────
  {
    slug: 'complex-ptsd-understanding-developmental-trauma',
    title: 'Complex PTSD: When the Trauma Was Not One Event but an Entire Childhood',
    category: 'Trauma',
    excerpt: 'Complex PTSD emerges from prolonged, repeated trauma — particularly in childhood. It requires a different understanding and a different treatment approach.',
    content: `# Complex PTSD: When the Trauma Was Not One Event but an Entire Childhood
...
If you have lived through prolonged trauma and recognise yourself here, please know that effective help exists. You did not cause what happened to you. And you do not have to carry its weight alone forever.`,
  ...
  {
    slug: 'childhood-trauma-long-term-effects',
    title: 'Childhood Trauma: How Early Experiences Shape Adult Life',
    category: 'Trauma',
    excerpt: 'The brain is most plastic in childhood — which means early trauma has deep effects. Understanding these effects is the beginning of changing them.',
    content: `# Childhood Trauma: How Early Experiences Shape Adult Life
...
Trauma-focused therapy, body-based approaches, and long-term therapeutic relationships can all facilitate healing from childhood adversity. The brain retains plasticity throughout life. The patterns learned early can be updated.`,
  ...
  {
    slug: 'somatic-healing-trauma-lives-in-the-body',
    title: 'Somatic Healing: Why Trauma Lives in the Body and How to Release It',
    category: 'Trauma',
    excerpt: 'Trauma is not only a mental event. It is stored in the body — in tension, breath patterns, startle responses, and disconnection. Healing requires working with the body, not just the mind.',
    content: `# Somatic Healing: Why Trauma Lives in the Body and How to Release It
...
The body is not the enemy. It is the location of healing.`,
  },
  {
    ...
    title: 'EMDR Therapy: What It Is, How It Works, and Who It Helps',
    category: 'Trauma',
    excerpt: 'EMDR is one of the most evidence-based trauma treatments available. Here is a clear, demystified explanation of what it actually involves.',
    content: `# EMDR Therapy: What It Is, How It Works, and Who It Helps
...
1. **History-taking**: Understanding the client's history and identifying target memories.
2. **Preparation**: Building coping resources and explaining the process.
3. **Assessment**: Identifying the specific components of the target memory.
4. **Desensitisation**: Processing the memory with bilateral stimulation.
5. **Installation**: Strengthening positive beliefs.
6. **Body scan**: Checking for remaining body tension.
7. **Closure**: Ensuring stability at the end of each session.
8. **Reevaluation**: Reviewing progress at the start of subsequent sessions.
...
It is not an easy process, but for many people it produces relief that talk therapy alone did not — a way of putting down a weight that had been carried for a very long time.`,
  ...
  {
    slug: 'intergenerational-trauma-healing-inherited-wounds',
    title: 'Intergenerational Trauma: Healing Wounds That Were Not Originally Yours',
    category: 'Trauma',
    excerpt: 'Trauma can pass through families across generations — through parenting, epigenetics, and the transmission of fear and coping patterns. Understanding this is the beginning of changing it.',
    content: `# Intergenerational Trauma: Healing Wounds That Were Not Originally Yours
...
One of the most powerful aspects of this work is the recognition that the healing you do is not only for you. Every generation that does this work reduces what passes to the next. You can be the place in your lineage where the transmission changes.`,
  ...
  // ─── RELATIONSHIPS ─────────────────────────────────────────────────────────
  {
    slug: 'attachment-styles-adult-relationships',
    title: 'Attachment Styles: How Your Earliest Bonds Shape Your Adult Relationships',
    category: 'Relationships',
    excerpt: 'The way you were loved as a child creates a template for how you love and are loved as an adult. Understanding your attachment style changes everything.',
    content: `# Attachment Styles: How Your Earliest Bonds Shape Your Adult Relationships
...
An attachment-informed therapist can help you identify your patterns, understand their origins, and build the capacity for relationships that are genuinely secure.`,
  ...
  {
    slug: 'codependency-and-relationships',
    title: 'Codependency: When Love Becomes Self-Erasure',
    category: 'Relationships',
    excerpt: 'Codependency is not love — it is fear in love\'s clothing. Understanding the difference is the beginning of building relationships that are genuinely mutual.',
    content: `# Codependency: When Love Becomes Self-Erasure
...
You can love generously without disappearing. The two are not in conflict.`,
  ...
  {
    slug: 'couples-therapy-what-to-expect',
    title: 'Couples Therapy: What It Is, What to Expect, and When to Start',
    category: 'Relationships',
    excerpt: 'Couples therapy is not for relationships that are failing. It is for relationships that are worth fighting for — and the research on when to start will surprise you.',
    content: `# Couples Therapy: What It Is, What to Expect, and When to Start
...
If you are considering it, the fact that you are considering it is probably the sign you need.`,
  ...
  {
    slug: 'loneliness-and-mental-health',
    title: 'Loneliness: The Silent Public Health Crisis and What to Do About It',
    category: 'Relationships',
    excerpt: 'Loneliness is not the same as being alone. It is a biological signal — as urgent as hunger — that connection is insufficient. And it is reaching epidemic levels.',
    content: `# Loneliness: The Silent Public Health Crisis and What to Do About It
...
If you are lonely, you are not broken. You are experiencing a real and legitimate need. And there are genuine ways to address it.`,
  ...
  {
    slug: 'family-systems-therapy-understanding-family-dynamics',
    title: 'Family Systems Therapy: Why Changing Yourself Changes Your Family',
    category: 'Relationships',
    excerpt: 'Families are systems — changing one part changes the whole. Understanding this shifts both the problem and the solution.',
    content: `# Family Systems Therapy: Why Changing Yourself Changes Your Family
...
This is why individual therapy informed by systems thinking can produce ripple effects in families and relationships. You cannot change others, but you can change how you function — and that changes everything.`,
  ...
  // ─── MINDFULNESS & WELLNESS ───────────────────────────────────────────────
  {
    ...
    title: 'The Body Scan: A Complete Guide to One of Mindfulness\'s Most Powerful Practices',
    category: 'Mindfulness',
    excerpt: 'The body scan is a foundational mindfulness practice that builds interoceptive awareness — the capacity to sense and understand what is happening in your body from the inside.',
    content: `# The Body Scan: A Complete Guide to One of Mindfulness's Most Powerful Practices
...
Begin with once daily, even for ten minutes. The relationship with your body that develops is one of the most valuable you can cultivate.`,
  ...
  {
    slug: 'sleep-hygiene-mental-health-connection',
    title: 'Sleep and Mental Health: The Connection You Cannot Afford to Ignore',
    category: 'Mindfulness',
    excerpt: 'Sleep is not a luxury or a self-care indulgence. It is a biological necessity — and its relationship with mental health is bidirectional and urgent.',
    content: `# Sleep and Mental Health: The Connection You Cannot Afford to Ignore
...
And if sleep problems are chronic, they are worth treating specifically. A therapist trained in CBT-I can help you break the cycle.`,
  },
  {
    ...
    title: 'Burnout Recovery: What It Takes to Come Back from Empty',
    category: 'Mindfulness',
    excerpt: 'Burnout is not fixed by a holiday. It is a state of chronic depletion that requires real rest, real change, and sometimes professional support.',
    content: `# Burnout Recovery: What It Takes to Come Back from Empty
...
You are not weak for burning out. You are human, with limits, in a world that often refuses to acknowledge them. Recovery is possible.`,
  ...
  {
    slug: 'self-compassion-why-being-kind-to-yourself-is-not-soft',
    title: 'Self-Compassion: Why Being Kind to Yourself Is Not Soft — It\'s Evidence-Based',
    category: 'Mindfulness',
    excerpt: 'Self-compassion is not self-pity or self-indulgence. Research consistently shows it is associated with greater resilience, motivation, and psychological wellbeing than self-criticism.',
    content: `# Self-Compassion: Why Being Kind to Yourself Is Not Soft — It's Evidence-Based
...
async function main() {
  ...
  // Get admin user to attribute posts to
